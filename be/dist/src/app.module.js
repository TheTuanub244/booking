...
const serviceAccount = __importStar(require("./config/booking-app-1edf4-firebase-adminsdk-dwj66-9dfe80f215.json"));
...
let AppModule = class AppModule {
    configure(consumer) {
        consumer.apply(DefaultRole_Middleware_1.DefaultRoleMiddleware).forRoutes('*');
    }
};
