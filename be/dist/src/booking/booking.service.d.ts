...
export declare class BookingService {
    ...
    constructor(bookingSchema: Model<Booking>, sessionSchema: Model<Session>, sessionService: SessionService, promotionSchema: Model<Promotion>, roomSchema: Model<Room>, promotionService: PromotionService);
    calculateTotalNightPrice(booking: any): Promise<number>;
    createBooking(createBookingDto: CreateBookingDto): Promise<mongoose.Document<unknown, {}, Booking> & Booking & {
