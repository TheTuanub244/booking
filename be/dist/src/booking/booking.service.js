...
let BookingService = class BookingService {
    constructor(bookingSchema, sessionSchema, sessionService, promotionSchema, roomSchema, promotionService) {
    ...
    async createBooking(createBookingDto) {
        const totalNightPrice = await this.calculateTotalNightPrice(createBookingDto);
