...
export declare class DestinationService {
    ...
    create(destination: CreateDestinationDto): Promise<import("mongoose").Document<unknown, {}, Destination> & Destination & {
        _id: Types.ObjectId;
    } & {
        __v?: number;
    }>;
    update(destination: UpdateDestinationDto): Promise<import("mongoose").UpdateWriteOpResult>;
