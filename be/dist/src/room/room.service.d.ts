...
export declare class RoomService {
  ...
  deleteRoom(id: ObjectId): Promise<
    mongoose.Document<unknown, {}, Room> &
      Room & {
        _id: Types.ObjectId;
      } & {
  ...
  getRoomWithProperty(property_id: ObjectId): Promise<
    (mongoose.Document<unknown, {}, Room> &
      Room & {
        _id: Types.ObjectId;
      } & {
  ...
  >;
  findAvailableRoomWithProperty(property_id: mongoose.Types.ObjectId): Promise<
    (mongoose.Document<unknown, {}, Room> &
      Room & {
        _id: Types.ObjectId;
      } & {
