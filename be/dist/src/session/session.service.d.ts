...
export declare class SessionService {
  ...
  createSession(createSessionDto: CreateSessionDto): Promise<
    import('mongoose').Document<unknown, {}, Session> &
      Session & {
  ...
  >;
  getSessionByUserId(userId: any): Promise<
    import('mongoose').Document<unknown, {}, Session> &
      Session & {
        _id: import('mongoose').Types.ObjectId;
      } & {
  ...
  signOut(userId: ObjectId): Promise<
    import('mongoose').Document<unknown, {}, Session> &
      Session & {
        _id: import('mongoose').Types.ObjectId;
      } & {
