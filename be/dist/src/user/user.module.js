...
let UserModule = class UserModule {
  configure(consumer) {
    consumer
      ...
      .forRoutes(
        { path: '/user/sign-up', method: common_1.RequestMethod.POST },
        { path: '/user/sign-in', method: common_1.RequestMethod.POST },
      )
      .apply(CreateUser_middleware_1.CreateUserMiddleware)
      .forRoutes(
        { path: '/user/create-user', method: common_1.RequestMethod.POST },
        { path: '/user/sign-up', method: common_1.RequestMethod.POST },
        { path: '/user/update-user', method: common_1.RequestMethod.POST },
      )
      .apply(ResetPassword_middleware_1.ResetPasswordMiddleware)
      .forRoutes(
        { path: '/user/reset-password', method: common_1.RequestMethod.POST },
        {
          path: '/user/checkResetPasswordToken',
