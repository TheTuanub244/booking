...
function EasyTrip({ propertyNear }) {
  ...
  const locationList = [
    {
      id: 1,
      image:
        "https://cf.bstatic.com/xdata/images/xphoto/300x240/140009656.jpg?k=350b38ee5a5f178f225d363eab93c7c14fbfee30168745e7db3a5fa38cd5be0e&o=",
      name: "Hai Phong",
      distance: "88 km away",
      typeTripId: 1,
    },
    ...
    },
    {
      id: 12,
      image:
        "https://cf.bstatic.com/xdata/images/xphoto/300x240/140009642.jpg?k=3693028a6e4723626d387e249096500276af3f45c9795f94d55cf753dc838926&o=",
      name: "Ninh Binh",
      distance: "87 km away",
      typeTripId: 2,
    },
  ...
  const [filteredLocationList, setFilteredLocationList] = useState(
    locationList.filter((item) => item.typeTripId === 1),
  );
  useEffect(() => {
    const filteredList = locationList.filter(
      (item) => item.typeTripId === type,
    );
    ...
    <div className="easyTrip">
      <div className="typeTripList">
        {typeTrip.map((item) => (
          <div
            className={
              type === item.id ? "typeTripItem active" : "typeTripItem"
            }
            key={item.id}
