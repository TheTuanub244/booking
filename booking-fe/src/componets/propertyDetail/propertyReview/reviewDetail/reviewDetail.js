      ...
      <div className="review-detail-profile">
        <div className="reviewer-profile">
          ...
          <div className="reviewer-name-nationality">
            <div className="reviewer-name">a{/* profile name*/}</div>
      ...
      <div className="review-detail-content">
        <div className="review-detail-overview">
          <div className="review-detail-header">
            ...
            <div className="review-detail-title">a{/*tieu de danh gia */}</div>
          </div>
          <div className="review-detail-rate">a{/*diem danh gia */}</div>
        </div>

        <div className="review-detail-text">
          {/* van ban danh gia */}a<br></br>
          <br></br>
          <br></br>
          <br></br>
        </div>
