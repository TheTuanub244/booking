...
function ReservationRoom_item({ room, numberOfNights, setSelectedRoom, setIsModalOpen, setModalRoom }){
                ...
                <tr key={room._id}>
                  <td>
                    <div className="roomName">
                        <a href='#' className="name" onClick={(e) => {e.preventDefault(); handleRoomClick()}}>{room.name}</a>
