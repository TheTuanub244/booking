              ...
              <table className="info-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span
                        className={room.price_per_night.weekday < room.price_per_night.weekend ? "lowerPrice-text" : ""}
                      >
                        {room.price_per_night.weekday} (Weekday)
                      </span>
                      /
                      <span
                        className={room.price_per_night.weekend < room.price_per_night.weekday ? "lowerPrice-text" : ""}
                      >
