...
import { faWifi, faPlaneDeparture, faUser,faInfo } from "@fortawesome/free-solid-svg-icons";
function Payment() {
  const [errorPayment,setErrorPayment] = useState("Please fill in your last name");
        ...
        <div className="paymentContainer">
          ...
          <div className="rightContent">
            ...
            <div className="yourDetails">
              ...
              <div className="yourAlert">Almost done! Just fill in the <span className="required">*</span> required info</div>
              </div>
              <div className="formInput">
                <form method="post" action="" id="payment_form" accept-charset="UTF-8">
                    <label>First name<span className="required">*</span></label>
                    <input type="text" className="form-control form-control-lg" name="firstname" required />
                    <label>Last name<span className="required">*</span></label>
                    <input type="text" className="form-control form-control-comment form-control-lg" name="lastname" required />
                    <label>Email address<span className="required">*</span></label>
                    <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" class="form-control form-control-lg" name="email" required />
                    <label>Phone number<span className="required">*</span></label>
                    <input type="text" pattern="\d+" id="Phone" className="form-control form-control-comment form-control-lg" name="phone" required />
