        ...
        <div className='paymentContainer'>
          <div className='leftContent'>
            <div className='bookingInformation'>
              ...
              <div className='address'>57/13 Bùi Viện, District 1, Ho Chi Minh City, Vietnam</div>
              ...
              <div className='infoExtra'>
                ...
                <div className='airport'>
                  <FontAwesomeIcon icon={faPlaneDeparture}  className='iconPlane'/>
              ...
              <div className='lengthStay'>
                ...
                <div className='selected'>
                    ...
                    <div className='mySelected'>
                      2 rooms for 2 adults
                    </div>
                    <button className='changeSelection'>Change your selection </button>
                   </div>
